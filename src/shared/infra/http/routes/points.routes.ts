...
import { GetDateMonthSelectedController } from "../../../../modules/points/useCases/getDateMonthSelected/GetDateMonthSelectedController";
...
const getDateMonthSelected = new GetDateMonthSelectedController();
...
pointsRoutes.get("/getDate/:userId", getDateMonthSelected.handle);
